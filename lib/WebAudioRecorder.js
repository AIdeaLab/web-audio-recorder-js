      ...
      this.worker.onmessage = function(event) {
        ...
        switch (data.command) {
          ...
          case "progress":
            ...
            break;
          case "complete":
            _this.onComplete(_this, data.blob, data.metadata);
            break;
          case "error":
